"""Freeze the guarded Task3 winner between portfolios 88.1 and 89.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryActivationInputScalePortfolio_90.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_activation_input_scale"
AUXILIARY_ARCHIVE_COUNT = 480
CURRENT_SOURCE_LABEL = "88.1"
AUXILIARY_SOURCE_LABEL = "89.1"
PORTFOLIO_LABEL = "90.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 88.1 and preregistered 89.1 winners"
)
