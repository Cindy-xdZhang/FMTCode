...
## Task4-c 4.13：邻近新采样测试，已提交

科学commit `52ae26a4`，原27,000训练束保持，另生成3,000邻近验证及10,000邻近测试，中心位移为原邻居距离5%–15%。原网络无正则化/正则化两组三种子，尚无完整科学F1。本版共享训练头区及源网格支持，只衡量局部泛化，不能替换原空间留出测试。见[4.13协议](Task4C_nearby_sampling_protocol_4.13.md)。
