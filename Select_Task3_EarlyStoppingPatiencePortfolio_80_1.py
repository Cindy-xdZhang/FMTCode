"""Freeze the guarded Task3 winner between portfolios 78.1 and 79.1."""
...
AUXILIARY_SOURCE_NAME = "early_stopping_patience"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "78.1"
AUXILIARY_SOURCE_LABEL = "79.1"
PORTFOLIO_LABEL = "80.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 78.1 and preregistered 79.1 winners"
)
