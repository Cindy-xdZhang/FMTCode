"""Freeze the guarded Task3 winner between portfolios 104.1 and 105.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadBeta2RefreshPortfolio_106.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_beta2_refresh"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "104.1"
AUXILIARY_SOURCE_LABEL = "105.1"
PORTFOLIO_LABEL = "106.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 104.1 and preregistered 105.1 winners"
)
