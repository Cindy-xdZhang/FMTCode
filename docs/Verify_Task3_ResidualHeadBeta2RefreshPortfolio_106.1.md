...
audited portfolio 104.1 and the 105.1 residual-head Adam beta2 winner.

## Frozen protocol

- Sources: 104.1 and 105.1 only; both source config hashes are frozen.
...
`Audit_Task3_ResidualHeadBeta2RefreshPortfolio_106_1.py` does not import the
106.1 selector. It independently reconstructs all seven family choices, macro
...
Preregistered before 105.1 produced any performance metric. No result is yet
