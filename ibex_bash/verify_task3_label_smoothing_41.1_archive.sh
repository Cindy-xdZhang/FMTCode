...
set -euo pipefail
cd "${TASK411_REPO_ROOT:-/home/zhanx0o/FMT_Task3_LabelSmoothing_41_1}"
mkdir -p slurm_logs

output_root="$PWD/outputs/Verify_Task3_LabelSmoothing_41.1"
...
# Require a byte-stable archive before publishing the formal hash list.
sync "$archive"
sleep 30
