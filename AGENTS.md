...
2026-09-14正在执行FMT v8.1五组比较：用户确认邻居138维按绝对值取前4项保留符号＋全部138项带符号均值；五组为原频域161、加方向233、加角度326、方向+角度398、V8频域100。Task4-c版本mainExp_Task4C_FMTv8_4.21，科学commita25bcc0d，预检51892537、训练51892616[0–14]及汇总51892617已全部完成，17进程/34事件/15预测核验PASS，V8测试F1=0.728480±0.004107、71,490参数、平均训练2.206分钟；Task1/3/5版本mainExp_Task135_FMTv8_1.1，科学commit0ae17ea2，预检51892661和真实小样本51892662均通过，Task1 51892691[0–29]已全部完成，V8平均F1=0.399681（原161维0.594613、纯fmt_v5 326维0.598571）；Task3→5 51892692[0–29]、审计51892705。所有几何组无kin/IVD估计，参数量与训练成本并列记录。协议docs/FMT_v8_protocol_1.1.md。用户明确将小Conv3D测试F1修订为0.7499±0.0126，来源为其另代码核验且要求不再复查；旧值不作为当前比较值。

2026-09-14用户要求`Ablation_Task4C_ConvResolution_4.22`：固定4.18小Conv3D的83,918参数，32³/36³/48³各三个种子，原24³参考采用用户修订0.7499±0.0126。代码与CPU工程检查完成；因4.18修订是否涉及数据/标签/评估尚待用户确认，正式生成与提交入口暂时阻止运行，尚无Ibex任务。协议`docs/Task4C_conv_resolution_protocol_4.22.md`。
