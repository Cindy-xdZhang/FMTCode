...
set -euo pipefail
cd "${TASK451_REPO_ROOT:-/home/zhanx0o/FMT_Task3_HeadAlphaClipCombination_45_1}"
mkdir -p slurm_logs

output_root="$PWD/outputs/Verify_Task3_HeadAlphaClipCombination_45.1"
