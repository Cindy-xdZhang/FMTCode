"""Freeze the guarded Task3 winner between portfolios 74.1 and 75.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_post_norm"
AUXILIARY_ARCHIVE_COUNT = 240
CURRENT_SOURCE_LABEL = "74.1"
AUXILIARY_SOURCE_LABEL = "75.1"
PORTFOLIO_LABEL = "76.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 74.1 and preregistered 75.1 winners"
)
