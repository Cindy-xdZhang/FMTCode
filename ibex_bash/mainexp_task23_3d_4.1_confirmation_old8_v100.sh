...
mkdir -p slurm_logs
DATASETS=(cylinder3d halfcylinderRe640 halfcylinderRe6400 tangaroa deltaWing_resampled deltaWing_LBM f22raptor channel)
...
python Build_Task23_FamilySearch_Confirmation.py \
  --group old8 --stage cache --dataset "$dataset"
