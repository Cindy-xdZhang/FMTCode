...
2026-09-15正在执行Ablation_FMTv8_NormFrequency_3.1：用户确认统一几何归一化、邻居倍率和特征标准化；4配方×5频率（2/4/6/10/16）共20组，Task3/5及Task4-c直接使用原验证集合比较。准备/原p35复现commit0d77e3e5，21项逐概率复现全部通过；搜索核心commitc61434ac，恢复Task4-c原V100/32束编码且逐值复现原缓存。预检51906453/51906546、准备51906470、复现51906471；原搜索51906472的Task3/5继续，未启动的Task4-c索引80–83取消并替换为51907432[0–19]单配置作业（仅调度适配器commit9b6b8451，核心函数不变）；汇总51906473等待两数组结束并要求420项完整。共149项登记，4项启动前取消，预计145项执行。任务3/5申请8GiB/30分钟，Task4-c24GiB/30分钟；并发8＋4共12卡，epoch不变。源数据333文件独立核验通过，未读test；协议docs/FMT_v8_norm_frequency_protocol_3.1.md。
