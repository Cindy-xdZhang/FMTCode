"""Freeze the guarded Task3 winner between portfolios 100.1 and 101.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadLearningRateRefreshPortfolio_102.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_learning_rate_refresh"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "100.1"
AUXILIARY_SOURCE_LABEL = "101.1"
PORTFOLIO_LABEL = "102.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 100.1 and preregistered 101.1 winners"
)
