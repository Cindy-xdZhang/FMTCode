"""Freeze the guarded Task3 winner between portfolios 98.1 and 99.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadNormActivationRefreshPortfolio_100.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_norm_activation_refresh"
AUXILIARY_ARCHIVE_COUNT = 600
CURRENT_SOURCE_LABEL = "98.1"
AUXILIARY_SOURCE_LABEL = "99.1"
PORTFOLIO_LABEL = "100.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 98.1 and preregistered 99.1 winners"
)
