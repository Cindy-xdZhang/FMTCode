...
# NOTE(restart 2026-08-16): PyflowVis renamed generate_FLowMap_SLICE -> generate_Flowmap_SLICE
# (FTLE_fitting_utils.py). The old import made this script un-runnable (ImportError).
