"""Freeze the guarded Task3 winner between portfolios 82.1 and 83.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryLinearWeightInitializationPortfolio_84.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_linear_weight_initialization"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "82.1"
AUXILIARY_SOURCE_LABEL = "83.1"
PORTFOLIO_LABEL = "84.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 82.1 and preregistered 83.1 winners"
)
