"""Freeze the guarded Task3 winner between portfolios 58.1 and 59.1.

This selector trains nothing and reads development artifacts only. Its source
identities and ranking rule are preregistered before 59.1 produces a metric.
"""
...
SELECTION_RULE = (
    ...
    "between independently audited 58.1 and preregistered 59.1 winners"
)
