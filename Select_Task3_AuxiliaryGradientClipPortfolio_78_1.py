"""Freeze the guarded Task3 winner between portfolios 76.1 and 77.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_gradient_clip"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "76.1"
AUXILIARY_SOURCE_LABEL = "77.1"
PORTFOLIO_LABEL = "78.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 76.1 and preregistered 77.1 winners"
)
