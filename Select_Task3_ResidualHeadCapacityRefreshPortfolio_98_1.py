"""Freeze the guarded Task3 winner between portfolios 96.1 and 97.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadCapacityRefreshPortfolio_98.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_capacity_refresh"
AUXILIARY_ARCHIVE_COUNT = 780
CURRENT_SOURCE_LABEL = "96.1"
AUXILIARY_SOURCE_LABEL = "97.1"
PORTFOLIO_LABEL = "98.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 96.1 and preregistered 97.1 winners"
)
