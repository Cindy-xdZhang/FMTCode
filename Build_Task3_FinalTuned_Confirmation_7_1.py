"""Build the sealed fifth spatial population for Task3 mainExp 7.1.

This module deliberately reuses the validated 6.1 cache builder while
temporarily replacing only the experiment identity, output roots, and the
pre-registered seed-grid phase.  Physical times, temporal source windows,
pathline integration settings, and IVD-p95 labels remain unchanged.
"""
...
import Build_Task3_AnchoredFeature_Confirmation_6_1 as _base


EXPERIMENT = "mainExp_Task3_3D_7.1"
PHASE_KEY = "mainExp_Task3_3D_7.1|fifth-spatial-population-v1"
PHASE_KEY_SHA256 = (
...
SETTINGS = {
    "old8": {
        ...
        "cache_dir": "outputs/mainExp_Task3_3D_7.1/confirmation_cache_old8",
        "label_config": "config/mainExp_Task3_3D_7.1_labels_old8.yaml",
        "indices": {
    ...
    "new2": {
        ...
        "cache_dir": "outputs/mainExp_Task3_3D_7.1/confirmation_cache_new2",
        "label_config": "config/mainExp_Task3_3D_7.1_labels_new2.yaml",
        "indices": {
...
SOURCE_STAGING_ENV = "TASK3_TUNED7_SOURCE_MANIFEST"
RECIPE_MANIFEST_ENV = "TASK3_TUNED7_RECIPE_MANIFEST"
DEFAULT_SOURCE_STAGING = (
    "/ibex/scratch/zhanx0o/FMT_Task3_FinalTuned_7_1/"
    "source_staging_manifest.json"
)
DEFAULT_RECIPE_MANIFEST = (
    "outputs/mainExp_Task3_3D_7.1/frozen_recipe_manifest.json"
)


@contextmanager
def _configured_base():
    """Apply the 7.1 constants only for one validated base-builder call."""
    replacements = {
