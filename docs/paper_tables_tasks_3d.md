...
## Task4-c 4.12：完整训练集拟合核验，已提交

科学commit `26f52805`。用户指定原27,000训练样本F1接近1；目标固定0.5阈值Hairpin F1≥0.99。原/增容FMT与Conv3D共四组，无正则化、无验证或测试读取。尚无完整训练结果，不能计作测试或泛化指标。见[4.12协议](Task4C_training_memorization_protocol_4.12.md)。
