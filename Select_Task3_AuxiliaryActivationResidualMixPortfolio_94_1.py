"""Freeze the guarded Task3 winner between portfolios 92.1 and 93.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryActivationResidualMixPortfolio_94.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_activation_residual_mix"
AUXILIARY_ARCHIVE_COUNT = 480
CURRENT_SOURCE_LABEL = "92.1"
AUXILIARY_SOURCE_LABEL = "93.1"
PORTFOLIO_LABEL = "94.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 92.1 and preregistered 93.1 winners"
)
