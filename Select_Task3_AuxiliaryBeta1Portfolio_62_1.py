"""Freeze the guarded Task3 winner between portfolios 60.1 and 61.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_beta1"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "60.1"
AUXILIARY_SOURCE_LABEL = "61.1"
PORTFOLIO_LABEL = "62.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 60.1 and preregistered 61.1 winners"
)
