...
## Task4-c 4.8：SAM正则化消融进行中

科学commit `81533108`，固定4.5三种子验证已选配置、4.1数据和4.3网络，仅比较扰动半径0/0.05/0.1。零半径普通AdamW与选定正半径均使用三种子验证；FMT/Conv3D参数88,514/219,602。已部署，尚无完整科学结果，4.6测试成绩保持。见[4.8协议](Task4C_sharpness_protocol_4.8.md)。
