...
def render(directory):
    ...
    def title(t):
        return (f'JHTDB {c["dataset_name"]} | {c["x_res"]} x {c["y_res"]} x {c["z_res"]} | '
    ...
    fig.write_html(out/'flow_3d.html',include_plotlyjs=True,auto_open=False,auto_play=False)
    print(out/'flow_3d.html')


if __name__=='__main__':
    p=argparse.ArgumentParser(description=__doc__)
    p.add_argument('directory',nargs='?',default='outputs/Verify_JHTDB_VTKDownload_1.1/isotropic')
