"""Verify that the Task4-b neural path can memorize the pooled channel+TBL cache.

Versioned copy of Verify_Task4B_FullVolumeMemorization_1_1 for the 3.1 pooled
cache (91,711 rows); only the frozen contract literals differ.
...
DEFAULT_CONFIG = Path("config/Verify_Task4B_PooledMemorization_3.1.yaml")
...
def run(
    ...
    *,
    ...
    if smoke_test:
        ...
        spec["experiment"] = "Verify_Task4B_PooledMemorizationSmoke_3.1"
        ...
        spec["output_dir"] = (
            "outputs/Verify_Task4B_PooledMemorizationSmoke_3.1/pooled"
        )
