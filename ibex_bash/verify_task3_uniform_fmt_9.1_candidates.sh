...
#SBATCH -J FMTT3u91
#SBATCH -o outputs/Verify_Task3_UniformFMT_9.1/logs/%x.%A_%a.out
#SBATCH -e outputs/Verify_Task3_UniformFMT_9.1/logs/%x.%A_%a.err
...
python -m experiments.Search_Task3_FMTResidual_3D \
  --config config/Verify_Task3_UniformFMT_9.1.yaml \
