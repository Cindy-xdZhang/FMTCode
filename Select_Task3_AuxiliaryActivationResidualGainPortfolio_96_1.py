"""Freeze the guarded Task3 winner between portfolios 94.1 and 95.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryActivationResidualGainPortfolio_96.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_activation_residual_gain"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "94.1"
AUXILIARY_SOURCE_LABEL = "95.1"
PORTFOLIO_LABEL = "96.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 94.1 and preregistered 95.1 winners"
)
