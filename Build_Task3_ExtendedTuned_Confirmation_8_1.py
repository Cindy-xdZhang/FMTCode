"""Build the sealed seventh spatial population for Task3 mainExp 8.1.

Only the preregistered spatial seed-grid phase and output identity differ from
7.2. Physical times, temporal windows, pathline integration, and whole-field
IVD-p95 labels remain unchanged.
"""
...
import Build_Task3_AdaptiveTuned_Confirmation_7_2 as _base


EXPERIMENT = "mainExp_Task3_3D_8.1"
PHASE_KEY = "mainExp_Task3_3D_8.1|seventh-spatial-population-v1"
PHASE_KEY_SHA256 = (
...
SETTINGS = {
    "old8": {
        ...
        "cache_dir": "outputs/mainExp_Task3_3D_8.1/confirmation_cache_old8",
        "label_config": "config/mainExp_Task3_3D_8.1_labels_old8.yaml",
        "indices": {
    ...
    "new2": {
        ...
        "cache_dir": "outputs/mainExp_Task3_3D_8.1/confirmation_cache_new2",
        "label_config": "config/mainExp_Task3_3D_8.1_labels_new2.yaml",
        "indices": {
...
SOURCE_STAGING_ENV = "TASK3_TUNED81_SOURCE_MANIFEST"
RECIPE_MANIFEST_ENV = "TASK3_TUNED81_RECIPE_MANIFEST"
DEFAULT_SOURCE_STAGING = (
    "/ibex/scratch/zhanx0o/FMT_Task3_ExtendedTuned_8_1/"
    "source_staging_manifest.json"
)
DEFAULT_RECIPE_MANIFEST = (
    "outputs/mainExp_Task3_3D_8.1/frozen_recipe_manifest.json"
)
