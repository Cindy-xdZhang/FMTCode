"""Freeze the guarded Task3 winner between portfolios 56.1 and 57.1.

This selector trains nothing and reads development artifacts only. Its source
identities and ranking rule are preregistered before 57.1 produces a metric.
"""
...
EXPERIMENT = "Verify_Task3_AuxiliaryRegularizationPortfolio_58.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_weight_decay"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "56.1"
AUXILIARY_SOURCE_LABEL = "57.1"
PORTFOLIO_LABEL = "58.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 56.1 and preregistered 57.1 winners"
)
