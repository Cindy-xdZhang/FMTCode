"""Freeze the guarded Task3 winner between portfolios 90.1 and 91.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryActivationInputShiftPortfolio_92.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_activation_input_shift"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "90.1"
AUXILIARY_SOURCE_LABEL = "91.1"
PORTFOLIO_LABEL = "92.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 90.1 and preregistered 91.1 winners"
)
