"""Freeze the guarded Task3 winner between portfolios 64.1 and 65.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_norm_scale"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "64.1"
AUXILIARY_SOURCE_LABEL = "65.1"
PORTFOLIO_LABEL = "66.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 64.1 and preregistered 65.1 winners"
)
