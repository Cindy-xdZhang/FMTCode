"""Freeze the guarded Task3 winner between portfolios 66.1 and 67.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_norm_bias"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "66.1"
AUXILIARY_SOURCE_LABEL = "67.1"
PORTFOLIO_LABEL = "68.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 66.1 and preregistered 67.1 winners"
)
