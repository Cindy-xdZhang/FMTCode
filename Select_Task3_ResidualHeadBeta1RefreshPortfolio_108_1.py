"""Freeze the guarded Task3 winner between portfolios 106.1 and 107.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadBeta1RefreshPortfolio_108.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_beta1_refresh"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "106.1"
AUXILIARY_SOURCE_LABEL = "107.1"
PORTFOLIO_LABEL = "108.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 106.1 and preregistered 107.1 winners"
)
