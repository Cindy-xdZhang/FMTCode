"""Freeze the guarded Task3 winner between portfolios 68.1 and 69.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_norm_epsilon"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "68.1"
AUXILIARY_SOURCE_LABEL = "69.1"
PORTFOLIO_LABEL = "70.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 68.1 and preregistered 69.1 winners"
)
