...
set -euo pipefail
cd "${TASK431_REPO_ROOT:-/home/zhanx0o/FMT_Task3_CosineMinLR_43_1}"
mkdir -p slurm_logs

output_root="$PWD/outputs/Verify_Task3_CosineMinLR_43.1"
...
for checkpoint in "${checkpoints[@]}"; do
  case "$checkpoint" in
    "$candidate_root"/*/checkpoints/*) rm -f -- "$checkpoint" ;;
    *)
