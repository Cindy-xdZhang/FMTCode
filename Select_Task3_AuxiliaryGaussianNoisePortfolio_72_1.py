"""Freeze the guarded Task3 winner between portfolios 70.1 and 71.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_gaussian_noise"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "70.1"
AUXILIARY_SOURCE_LABEL = "71.1"
PORTFOLIO_LABEL = "72.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 70.1 and preregistered 71.1 winners"
)
