"""Freeze the guarded Task3 winner between portfolios 62.1 and 63.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_epsilon"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "62.1"
AUXILIARY_SOURCE_LABEL = "63.1"
PORTFOLIO_LABEL = "64.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 62.1 and preregistered 63.1 winners"
)
