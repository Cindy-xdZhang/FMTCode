...
import time
import numpy as np
from Plot_AIVDTranslationObservers_VelocityArrows_3D import render
...
def main():
    ...
    parser.add_argument('--config',default='config/Verify_AIVDTranslationObservers_1.3.json')
    ...
    print('RENDER_COMPLETE: six velocity arrows and one zero marker; original paths and labels preserved.',flush=True)
