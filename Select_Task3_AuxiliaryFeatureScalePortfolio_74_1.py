"""Freeze the guarded Task3 winner between portfolios 72.1 and 73.1."""
...
AUXILIARY_SOURCE_NAME = "auxiliary_feature_scale"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "72.1"
AUXILIARY_SOURCE_LABEL = "73.1"
PORTFOLIO_LABEL = "74.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 72.1 and preregistered 73.1 winners"
)
