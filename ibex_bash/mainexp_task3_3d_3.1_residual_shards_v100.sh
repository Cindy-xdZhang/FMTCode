...
config="config/mainExp_Task3_3D_3.1_${mode}_${data_group}.yaml"
output_dir="outputs/mainExp_Task3_3D_3.1/development_${data_group}/${mode}_residual_shards/${dataset}"
