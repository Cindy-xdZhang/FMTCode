...
set -euo pipefail
cd "${TASK3109_REPO_ROOT:-/home/zhanx0o/FMT_Task3_ResidualHeadEpsilonRefresh_109_1}"
mkdir -p slurm_logs
source /home/zhanx0o/anaconda3/etc/profile.d/conda.sh
conda activate deepvortex

output_root="$PWD/outputs/Verify_Task3_ResidualHeadEpsilonRefresh_109.1"
