"""Freeze the guarded Task3 winner between portfolios 110.1 and 111.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadGradientClipRefreshPortfolio_112.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_gradient_clip_refresh"
AUXILIARY_ARCHIVE_COUNT = 540
CURRENT_SOURCE_LABEL = "110.1"
AUXILIARY_SOURCE_LABEL = "111.1"
PORTFOLIO_LABEL = "112.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 110.1 and preregistered 111.1 winners"
)
