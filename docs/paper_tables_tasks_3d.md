...
4.3（科学commit `46d7ee4e`）已完成24次开发训练，三种子验证F1为逐线FMT0.390572 ± 0.015530、宽Conv3D0.429361 ± 0.001251；验证AP均值0.309755/0.361637。独立复算通过，未通过0.6门槛，固定测试未编码。见[4.3协议](Task4C_line_pooling_protocol_4.3.md)。

4.4（科学commit `d14e8132`）在固定4.3网络中测试隐藏表示插值正则化，已提交16搜索+8复核；暂无性能结论，测试未使用。
