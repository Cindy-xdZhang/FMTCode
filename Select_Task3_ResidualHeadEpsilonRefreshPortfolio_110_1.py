"""Freeze the guarded Task3 winner between portfolios 108.1 and 109.1."""
...
EXPERIMENT = "Verify_Task3_ResidualHeadEpsilonRefreshPortfolio_110.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "residual_head_epsilon_refresh"
AUXILIARY_ARCHIVE_COUNT = 660
CURRENT_SOURCE_LABEL = "108.1"
AUXILIARY_SOURCE_LABEL = "109.1"
PORTFOLIO_LABEL = "110.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 108.1 and preregistered 109.1 winners"
)
