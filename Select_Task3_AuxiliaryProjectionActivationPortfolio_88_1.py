"""Freeze the guarded Task3 winner between portfolios 86.1 and 87.1."""
...
EXPERIMENT = "Verify_Task3_AuxiliaryProjectionActivationPortfolio_88.1"
CURRENT_SOURCE_NAME = "current_portfolio"
AUXILIARY_SOURCE_NAME = "auxiliary_projection_activation"
AUXILIARY_ARCHIVE_COUNT = 480
CURRENT_SOURCE_LABEL = "86.1"
AUXILIARY_SOURCE_LABEL = "87.1"
PORTFOLIO_LABEL = "88.1"
SELECTION_RULE = (
    "per physical family, maximize guarded development paired F1 gain "
    "between independently audited 86.1 and preregistered 87.1 winners"
)
