...
#SBATCH -J FMTT2u62
#SBATCH -o outputs/mainExp_Task2_3D_6.2_uniform_confirmation/logs/%x.%A_%a.out
#SBATCH -e outputs/mainExp_Task2_3D_6.2_uniform_confirmation/logs/%x.%A_%a.err
...
cd "$repo_root"
mkdir -p outputs/mainExp_Task2_3D_6.2_uniform_confirmation/logs
