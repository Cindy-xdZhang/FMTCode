...
set -euo pipefail
cd "${TASK369_REPO_ROOT:-/home/zhanx0o/FMT_Task3_AuxiliaryNormEpsilon_69_1}"
mkdir -p slurm_logs
source /home/zhanx0o/anaconda3/etc/profile.d/conda.sh
conda activate deepvortex

output_root="$PWD/outputs/Verify_Task3_AuxiliaryNormEpsilon_69.1"
